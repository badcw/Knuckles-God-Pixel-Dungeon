...
package com.knucklesgod.knucklesgodpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.actors.actors",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.items.items",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.journal.journal",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.levels.levels",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.plants.plants",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.scenes.scenes",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.ui.ui",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.windows.windows",
			"com.shatteredpixel.knucklesgodpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredpixel.knucklesgodpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
