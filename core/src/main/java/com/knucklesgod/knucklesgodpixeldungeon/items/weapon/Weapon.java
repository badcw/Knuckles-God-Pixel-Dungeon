...
package com.knucklesgod.knucklesgodpixeldungeon.items.weapon;
...
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Annoying;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Displacing;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Elastic;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Exhausting;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Fragile;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Friendly;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Sacrificial;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.curses.Wayward;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Blazing;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Chilling;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Dazzling;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Eldritch;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Grim;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Lucky;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Projecting;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Shocking;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Stunning;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Unstable;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Vampiric;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Venomous;
import com.knucklesgod.knucklesgodpixeldungeon.items.weapon.enchantments.Vorpal;
